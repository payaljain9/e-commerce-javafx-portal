...
public class SearchProductScreen {
	public void show()
	{
		...
		StageFactory.getStage().setTitle("Search Product Screen");
		
		//
		Parent actorgroup=null;
		try 
		{
			actorgroup = FXMLLoader.load(getClass().getResource("/Search Product2.fxml"));
		} 
		catch (IOException e) 
		{
			//displaying error msg
			 ...
			 alert.setContentText("Can't Open Search Product.fxml..!\nClosing Application..");
			 alert.showAndWait();
			 System.exit(0);
		}
