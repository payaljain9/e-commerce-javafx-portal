...
public class AddProductScreen {
	public void show()
	{
		...
		StageFactory.getStage().setTitle("Add Product Screen");
		
		//
		Parent actorgroup=null;
		try 
		{
			actorgroup = FXMLLoader.load(getClass().getResource("/Add Product2.fxml"));
		} 
		catch (IOException e) 
		{
			 ...
			 alert.setContentText("Can't Open Add Product.fxml..!\nClosing Application..");
			 alert.showAndWait();
			 System.exit(0);
		}
