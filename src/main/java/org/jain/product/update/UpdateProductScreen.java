...
public class UpdateProductScreen {
	public void show()
	{
		...
		StageFactory.getStage().setTitle("Update Product Screen");
		
		//
		Parent actorgroup=null;
		try 
		{
			actorgroup = FXMLLoader.load(getClass().getResource("/Update Product2.fxml"));
		} 
		catch (IOException e) 
		{
			//displaying error msg
			 ...
			 alert.setContentText("Can't Open Update Product.fxml..!\nClosing Application..");
			 alert.showAndWait();
			 System.exit(0);
		}
