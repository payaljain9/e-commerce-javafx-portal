...
public class DeleteUserScreen {
	public void show()
	{
		...
		StageFactory.getStage().setTitle("Delete User Screen");
		
		//
		Parent actorgroup=null;
		try 
		{
			actorgroup = FXMLLoader.load(getClass().getResource("/Delete User2.fxml"));
		} 
		catch (IOException e) 
		{
			e.printStackTrace();
			 ...
			 alert.setContentText("Can't Open Delete Delete User.fxml..!\nClosing Application..");
			 alert.showAndWait();
			 System.exit(0);
		}
