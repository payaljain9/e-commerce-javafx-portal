...
public class AddUserScreen {
	public void show()
	{
		...
		StageFactory.getStage().setTitle("Add User Screen");
		
		//
		Parent actorgroup=null;
		try 
		{
			actorgroup = FXMLLoader.load(getClass().getResource("/Add User2.fxml"));
		} 
		catch (IOException e) 
		{
			e.printStackTrace();
		    ...
		    alert.setContentText("Can't Open Add User.fxml..!\nClosing Application..");
			alert.showAndWait();
			System.exit(0);
		}
